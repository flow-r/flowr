...
+--------------+-----------+-------------------------------------------------------------------------------------------------+
| sample1      | tmp       | head -c 100000 /dev/urandom > tmp1\_4                                                           |
+--------------+-----------+-------------------------------------------------------------------------------------------------+
| sample1      | tmp       | head -c 100000 /dev/urandom > tmp1\_5                                                           |
+--------------+-----------+-------------------------------------------------------------------------------------------------+
| sample1      | tmp       | head -c 100000 /dev/urandom > tmp1\_6                                                           |
+--------------+-----------+-------------------------------------------------------------------------------------------------+
| sample1      | tmp       | head -c 100000 /dev/urandom > tmp1\_7                                                           |
+--------------+-----------+-------------------------------------------------------------------------------------------------+
| sample1      | tmp       | head -c 100000 /dev/urandom > tmp1\_8                                                           |
+--------------+-----------+-------------------------------------------------------------------------------------------------+
| sample1      | tmp       | head -c 100000 /dev/urandom > tmp1\_9                                                           |
+--------------+-----------+-------------------------------------------------------------------------------------------------+
| sample1      | tmp       | head -c 100000 /dev/urandom > tmp1\_10                                                          |
+--------------+-----------+-------------------------------------------------------------------------------------------------+
| sample1      | merge     | cat tmp1\_1 tmp1\_2 tmp1\_3 tmp1\_4 tmp1\_5 tmp1\_6 tmp1\_7 tmp1\_8 tmp1\_9 tmp1\_10 > merge1   |
+--------------+-----------+-------------------------------------------------------------------------------------------------+
