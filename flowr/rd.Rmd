...
<p><strong>Version:</strong> 0.9.7.9015</p>
...
A   ----> B  -----> C -----> D<\br>
<em>This refers to the sub_type column in flow definition.</em>
<ul>
...
<dl class="rd-dl">
 ...
 Values are integers varying from 0, 1, 2, 3, .... Please refer to the flowr_verbose page for more details.
...
<div>## method for class 'flow'
kill(x, kill_cmd, jobid_col&nbsp;=&nbsp;"job_sub_id", ...)</div></code></pre>
...
rerun(x, ...)</div>
<div>## method for class 'flow'
rerun(x, mat, def, start_from, execute&nbsp;=&nbsp;TRUE, kill&nbsp;=&nbsp;TRUE, ...)</div></code></pre>
