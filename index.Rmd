...
**Complete documentation is also available as [PDF here](http://docs.flowr.space/flowr.pdf)**. 

Disclamer: Since we are using the same source for HTML and PDF, some plots/tables may not render perfectly in the PDF.

Also, the package reference (describing all functions) is also [available as PDF](http://docs.flowr.space/flowr_manual.pdf).
