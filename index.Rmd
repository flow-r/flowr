...
<<<<<<< HEAD
=======
<iframe width="640" height="480" src="https://www.youtube.com/embed/szDNFioBdPo?rel=0&amp;showinfo=0;autoplay=0;start=29;speed=2" frameborder="0" volume="0"></iframe>.
>>>>>>> origin/gh-pages
...
**Complete documentation is also available as [PDF here](http://docs.flowr.space/flowr_manual.pdf)**. 

Disclamer: Since we are using the same source for HTML and PDF, some plots/tables may not render perfectly in the PDF.

**Also, the package reference (describing all functions) is also [available as PDF](http://docs.flowr.space/flowr_pkg_ref.pdf).**
