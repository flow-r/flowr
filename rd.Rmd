...
<p><strong>Version:</strong> 0.9.8.9014</p>
...
<div>## method for class 'flowmat'
to_flowdef(x, sub_type, dep_type, prev_jobs, queue&nbsp;=&nbsp;"short", platform&nbsp;=&nbsp;"torque", memory_reserved&nbsp;=&nbsp;"2000", cpu_reserved&nbsp;=&nbsp;"1", walltime&nbsp;=&nbsp;"1:00", guess&nbsp;=&nbsp;TRUE, verbose&nbsp;=&nbsp;get_opts("verbose"), ...)</div>
<div>## method for class 'flow'
to_flowdef(x, ...)</div>
<div>## method for class 'character'
to_flowdef(x, ...)</div>
...
<h4>Usage</h4>
<pre class="r"><code><div>run(x, platform, def, conf, wd&nbsp;=&nbsp;get_opts("flow_run_path"), flow_run_path&nbsp;=&nbsp;wd, execute&nbsp;=&nbsp;FALSE, ...)</div>
<div>run_pipe(x, platform, def, conf, wd&nbsp;=&nbsp;get_opts("flow_run_path"), flow_run_path&nbsp;=&nbsp;wd, execute&nbsp;=&nbsp;FALSE, ...)</div></code></pre>
