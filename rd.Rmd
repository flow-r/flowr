...
<p><strong>Version:</strong> 0.9.8.9016</p>
...
<div>## method for class 'flowmat'
to_flowdef(x, sub_type, dep_type, prev_jobs, queue&nbsp;=&nbsp;"short", platform&nbsp;=&nbsp;"torque", memory_reserved&nbsp;=&nbsp;"2000", cpu_reserved&nbsp;=&nbsp;"1", walltime&nbsp;=&nbsp;"1:00", guess&nbsp;=&nbsp;FALSE, verbose&nbsp;=&nbsp;get_opts("verbose"), ...)</div>
<div>## method for class 'flow'
to_flowdef(x, ...)</div>
<div>## method for class 'character'
to_flowdef(x, ...)</div>
