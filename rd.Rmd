...
<p><strong>Version:</strong> 0.9.8.9010</p>
...
<h4>Usage</h4>
<pre class="r"><code><div>run(pipe_name, platform, def, flow_run_path&nbsp;=&nbsp;get_opts("flow_run_path"), execute&nbsp;=&nbsp;FALSE, ...)</div>
<div>run_pipe(pipe_name, platform, def, flow_run_path&nbsp;=&nbsp;get_opts("flow_run_path"), execute&nbsp;=&nbsp;FALSE, ...)</div></code></pre>
