...
<dl class="rd-dl">
  ...
  <dt>flow_run_path</dt>
  <dd class="rd-dd">Path to a folder. Main operating folder for this flow. [<code>opts_flow$get("flow_run_path")</code>]
...
This over-rides the platform column in flowdef. (optional)</dd>
  <dt>containerize</dt>
  <dd class="rd-dd">flowr could create a new folder and pull all flows in them, keep the process clean</dd>
  <dt>submit</dt>
...
rerun(x, ...)</div>
<div>## method for class 'flow'
rerun(x, mat, def, start_from, execute&nbsp;=&nbsp;TRUE, kill&nbsp;=&nbsp;TRUE, select, ignore, verbose&nbsp;=&nbsp;opts_flow$get("verbose"), ...)</div></code></pre>
