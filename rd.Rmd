...
<p><strong>Version:</strong> 0.9.8.9019</p>
...
to_flow(x, def, grp_col, jobname_col, cmd_col, flowname, flow_run_path, platform, containerize&nbsp;=&nbsp;TRUE, submit&nbsp;=&nbsp;FALSE, execute&nbsp;=&nbsp;FALSE, qobj, verbose&nbsp;=&nbsp;get_opts("verbose"), ...)</div>
<div>## method for class 'data.frame'
to_flow(x, ...)</div>
<div>## method for class 'list'
to_flow(x, def, flowname, flow_run_path, desc, qobj, module_cmds&nbsp;=&nbsp;"", verbose&nbsp;=&nbsp;get_opts("verbose"), ...)</div></code></pre>
...
<div>## method for class 'flowmat'
to_flowdef(x, sub_type, dep_type, prev_jobs, queue&nbsp;=&nbsp;"short", platform&nbsp;=&nbsp;"torque", memory_reserved&nbsp;=&nbsp;"2000", cpu_reserved&nbsp;=&nbsp;"1", nodes&nbsp;=&nbsp;"1", walltime&nbsp;=&nbsp;"1:00", guess&nbsp;=&nbsp;FALSE, verbose&nbsp;=&nbsp;get_opts("verbose"), ...)</div>
<div>## method for class 'flow'
to_flowdef(x, ...)</div>
<div>## method for class 'character'
to_flowdef(x, ...)</div>
...
<h4>Usage</h4>
<pre class="r"><code><div>run(x, platform, def, conf, wd&nbsp;=&nbsp;get_opts("flow_run_path"), flow_run_path&nbsp;=&nbsp;wd, rerun_wd, start_from, execute&nbsp;=&nbsp;FALSE, ...)</div>
<div>run_pipe(x, platform, def, conf, wd&nbsp;=&nbsp;get_opts("flow_run_path"), flow_run_path&nbsp;=&nbsp;wd, rerun_wd, start_from, execute&nbsp;=&nbsp;FALSE, ...)</div></code></pre>
...
<h4>Usage</h4>
<pre class="r"><code><div>flow(jobs&nbsp;=&nbsp;list(new("job")), name&nbsp;=&nbsp;"newflow", desc&nbsp;=&nbsp;"my_super_flow", mode&nbsp;=&nbsp;c("scheduler", "trigger", "R"), flow_run_path&nbsp;=&nbsp;get_opts("flow_run_path"), trigger_path&nbsp;=&nbsp;"", flow_path&nbsp;=&nbsp;"", version&nbsp;=&nbsp;"0.0", status&nbsp;=&nbsp;"created", module_cmds&nbsp;=&nbsp;get_opts("module_cmds"), execute&nbsp;=&nbsp;"")</div></code></pre>
