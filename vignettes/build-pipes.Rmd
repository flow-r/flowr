...
opts_chunk$set(fig.height=5, fig.width=6)
...
```{r plot_example1, fig.cap="Flow chart describing process for example 1", message=FALSE}
plot_flow(fobj)
```
...
It might be useful to [compare various cluster platforms.](http://en.wikipedia.org/wiki/Comparison_of_cluster_software)
